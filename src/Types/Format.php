...
use Manno\DoctrineRestDriver\Formatters\Formatter;
...
class Format
{
    ...
    public static function create(array $options)
    {
        ...
        $className      = preg_match('/\\\\/', $formatterClass) ? $formatterClass : 'Manno\DoctrineRestDriver\Formatters\\' . $formatterClass;
