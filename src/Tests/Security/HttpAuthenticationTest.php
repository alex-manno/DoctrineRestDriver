...
namespace Manno\DoctrineRestDriver\Tests\Security;

use Manno\DoctrineRestDriver\Enums\HttpMethods;
use Manno\DoctrineRestDriver\Security\HttpAuthentication;
 ...
 *
 * @coversDefaultClass Manno\DoctrineRestDriver\Security\HttpAuthentication
 */
