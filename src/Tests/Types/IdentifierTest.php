...
use Manno\DoctrineRestDriver\Types\Identifier;
 ...
 *
 * @coversDefaultClass Manno\DoctrineRestDriver\Types\Identifier
 */
class IdentifierTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function column()
    {
        ...
        $metaData = $this->getMockBuilder('Manno\DoctrineRestDriver\MetaData')->disableOriginalConstructor()->getMock();
        $metaData
            ->expects($this->once())
            ->method('get')
