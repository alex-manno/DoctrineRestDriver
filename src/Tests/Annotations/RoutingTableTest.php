 ...
 *
 * @coversDefaultClass Manno\DoctrineRestDriver\Annotations\RoutingTable
 */
class RoutingTableTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $entities = [
            'categories'     => 'Manno\DoctrineRestDriver\Tests\Entity\AssociatedEntity',
            'nonImplemented' => 'Manno\DoctrineRestDriver\Tests\Entity\NonImplementedEntity',
            'products'       => 'Manno\DoctrineRestDriver\Tests\Entity\TestEntity',
        ];
