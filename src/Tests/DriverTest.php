...
use Manno\DoctrineRestDriver\Driver;
 ...
 *
 * @coversDefaultClass Manno\DoctrineRestDriver\Driver
 */
class DriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $connection = $this->getMockBuilder('Manno\DoctrineRestDriver\Connection')->disableOriginalConstructor()->getMock();
    ...
    {
        $params = [
            'driverClass'   => 'Manno\DoctrineRestDriver\Driver',
            'driverOptions' => [
        ...
        $this->assertInstanceOf('Manno\DoctrineRestDriver\Connection', $connection);
    }
}
