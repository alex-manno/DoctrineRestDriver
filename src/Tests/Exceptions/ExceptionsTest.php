...
namespace Manno\DoctrineRestDriver\Tests\Exceptions;
 ...
 *
 * @coversDefaultClass Manno\DoctrineRestDriver\Exceptions\Exceptions
 *
...
class ExceptionsTest extends \PHPUnit_Framework_TestCase
{
     ...
     * @expectedException \Manno\DoctrineRestDriver\Validation\Exceptions\NotNilException
     */
     ...
     * @covers Manno\DoctrineRestDriver\Exceptions\UnsupportedFetchModeException::__construct
     * @expectedException \Manno\DoctrineRestDriver\Exceptions\UnsupportedFetchModeException
     *
     * @SuppressWarnings("PHPMD.StaticAccess")
     */
     ...
     * @covers Manno\DoctrineRestDriver\Exceptions\MethodNotImplementedException::__construct
     * @expectedException \Manno\DoctrineRestDriver\Exceptions\MethodNotImplementedException
     *
     * @SuppressWarnings("PHPMD.StaticAccess")
     */
     ...
     * @covers Manno\DoctrineRestDriver\Exceptions\RequestFailedException::__construct
     * @expectedException \Manno\DoctrineRestDriver\Exceptions\RequestFailedException
     *
     * @SuppressWarnings("PHPMD.StaticAccess")
     */
     ...
     * @covers Manno\DoctrineRestDriver\Exceptions\InvalidAuthStrategyException::__construct
     * @expectedException \Manno\DoctrineRestDriver\Exceptions\InvalidAuthStrategyException
     *
     * @SuppressWarnings("PHPMD.StaticAccess")
     */
     ...
     * @covers Manno\DoctrineRestDriver\Exceptions\InvalidSqlOperationException::__construct
     * @expectedException \Manno\DoctrineRestDriver\Exceptions\InvalidSqlOperationException
     *
     * @SuppressWarnings("PHPMD.StaticAccess")
     */
     ...
     * @covers Manno\DoctrineRestDriver\Exceptions\InvalidFormatException::__construct
     * @expectedException \Manno\DoctrineRestDriver\Exceptions\InvalidFormatException
     *
     * @SuppressWarnings("PHPMD.StaticAccess")
     */
