...
namespace Manno\DoctrineRestDriver\Tests\Validation;
 ...
 *
 * @coversDefaultClass Manno\DoctrineRestDriver\Validation\Assertions
 */
class AssertionsTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame(null, Assertions::assertClassExists('Manno\DoctrineRestDriver\Tests\Validation\AssertionsTest'));
    }
